defmodule PlateSlate.OrderingTest do
  ...
  describe "orders" do
    ...
    @valid_attrs %{customer_number: 42, items: %{}, ordered_at: "2010-04-17 14:00:00.000000Z", state: "some state"}
    @update_attrs %{customer_number: 43, items: %{}, ordered_at: "2011-05-18 15:01:01.000000Z", state: "some updated state"}
